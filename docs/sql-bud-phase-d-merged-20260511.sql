-- ============================================================
-- Bud Phase D 13 件 + 前提拡張 merged SQL
-- ============================================================
-- 起草: a-main-023 / 2026-05-11 18:35
...
create policy pr_approve on public.bud_payroll_records
  ...
  using (
    status = 'calculated'
    and public.bud_has_payroll_role(array['payroll_approver'])
    and calculated_by <> (select id from public.root_employees where user_id = auth.uid() and deleted_at is null)
  )
  with check (
    status = 'approved'
    and public.bud_has_payroll_role(array['payroll_approver'])
