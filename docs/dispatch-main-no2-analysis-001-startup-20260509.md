...
dispatch counter リセット違反のため、本ファイル（main- No. 2 と表記）は破棄。

## 正規番号への移動

| 旧（破棄） | 新（正規） |
|---|---|
| main- No. 2 | main- No. 203 |
| docs/dispatch-main-no2-analysis-001-startup-20260509.md | docs/dispatch-main-no203-analysis-001-startup-20260510.md |
