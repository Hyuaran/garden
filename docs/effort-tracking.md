...
| Leaf | A-1c spec/plan v3.2 改訂（a-review #65 セキュリティ修正反映、bcryptjs 不要化 / 平文 PW 直送 / search_path = ''） | 0.125 (1.0h) | 0.10 (50min) | -0.025 | a-leaf-002 (A) | 2026-05-07 | 2026-05-07 | a-main-013 main- No. 86 全前倒し dispatch # 1。spec +121/-43 + plan +93/-43 = +214/-86 行。PR #130 OPEN。実コード正本は commit `4247005`、spec/plan は文書同期のみ。見積 6.7d → 6.7d 変更なし |
| Leaf | Phase A 着手前 準備ガイド起票（9 task の test plan + skeleton + GO 判定フロー）| 0.19 (1.5h) | 0.05 (25min) | -0.14 | a-leaf-002 (A) | 2026-05-07 | 2026-05-07 | a-main-013 # 2。docs/leaf-phase-a-implementation-prep-20260507.md 194 行。9 セクション（概要 / 前提条件 15 項目 / 9 task サマリ / skeleton / 認証 / v3.2 影響 / GO フロー）。PR #132 OPEN。72% 短縮 |
| Leaf | TimeTree 移行 設計書起票（Phase B-2、半自動方式、6 論点全 OK 採用）| 0.25 (2.0h) | 0.06 (30min) | -0.19 | a-leaf-002 (A) | 2026-05-07 | 2026-05-07 | a-main-013 # 3 / main- No. 93 で 6 論点全 OK。docs/superpowers/specs/2026-05-07-leaf-timetree-migration-design.md 304 行。CSV エクスポート + 手動アップロード支援 UI、見積 2.5d。PR #133 OPEN。75% 短縮 |
| Leaf | OCR 自動化 設計書起票（Phase C、Google Vision API、3 段階展開、7 論点全 OK 採用）| 0.25 (2.0h) | 0.07 (35min) | -0.18 | a-leaf-002 (A) | 2026-05-07 | 2026-05-07 | a-main-013 # 4 / main- No. 95 で 7 論点全 OK。docs/superpowers/specs/2026-05-07-leaf-ocr-design.md 506 行。Google Vision API + 月 $10 予算 + 80% しきい値 + 3 段階展開（受領書 → メーター → 手書き）。バックグラウンド処理（Edge Functions + Queue）。見積 3.5d。PR #134 OPEN。71% 短縮 |
| Leaf | 5 PR 横断セルフレビュー + effort-tracking 更新 + known-pitfalls Leaf 観点追記（A+B+C）| 0.09 (70min) | 0.07 (50min) | -0.02 | a-leaf-002 (A) | 2026-05-07 | 2026-05-07 | a-main-013 main- No. 98 dispatch、自律化可能タスク並列実施。A: docs/leaf-cross-spec-review-20260507.md（5 PR 横断整合チェック、6 観点 全 ✅）/ B: 本表に Leaf 5 行追記 / C: known-pitfalls #9 SECURITY DEFINER search_path / #10 クライアント側 hash 化脆弱性 / #11 GitHub ghost PR 衝突 の 3 件追加 |
