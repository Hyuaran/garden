export const transferFormStyles = {
  ...
  secondaryButton:
    "rounded-garden-input border border-[rgba(179,137,46,0.24)] bg-bg-card-solid px-4 py-2 text-sm text-text-sub transition hover:border-[rgba(179,137,46,0.36)] hover:bg-bg-card-hover disabled:opacity-50",
  mutedButton:
    "rounded-garden-input border border-[rgba(179,137,46,0.22)] bg-[rgba(212,165,65,0.10)] px-4 py-2 text-sm text-text-main transition hover:bg-[rgba(212,165,65,0.16)] disabled:opacity-50",
  goldButton:
    "rounded-garden-input bg-accent-gold px-4 py-2 text-sm font-medium text-white shadow-garden-soft transition hover:bg-[#b3892e] disabled:opacity-50",
  smallGoldButton:
  ...
  linkButton:
    "rounded-garden-input border border-[rgba(179,137,46,0.30)] bg-bg-card-solid px-3 py-2 text-sm text-text-main transition hover:bg-[rgba(212,165,65,0.10)] disabled:opacity-50",
  alert:
