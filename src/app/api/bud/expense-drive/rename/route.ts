 ...
 *   形式: {レシート日付YYYYMMDD}_{社員番号}_{店名}_{金額}.jpg
 *   例:   20260512_0008_三井のリパーク_500.jpg
 *
...
export async function POST(req: Request) {
  try {
    ...
    const { data: row } = await supabase
      ...
      .select("drive_file_id, applicant_employee_id, receipt_date, store_name, amount")
    ...
    const name = `${ymd}_${empNo}_${store}_${amount}.jpg`;
