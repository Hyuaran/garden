...
export default function SyncStatusClient() {
  ...
  return <div className={`${styles.shell} ${styles.shellEmbedded}`}><div className={`${styles.main} ${styles.mainEmbedded}`}><header className={styles.header}><div><SystemBreadcrumb items={[{ label: "勤怠打刻", href: "/system/attendance" }, { label: "同期状況" }]} /><h1>同期状況</h1></div></header>
