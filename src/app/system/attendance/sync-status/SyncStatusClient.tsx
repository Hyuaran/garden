...
export default function SyncStatusClient() {
  ...
  return <div className={`${styles.shell} ${styles.shellEmbedded}`}><div className={`${styles.main} ${styles.mainEmbedded}`}><header className={styles.header}><div><p className={styles.eyebrow}>System ／ 勤怠打刻</p><h1>同期状況</h1></div><Link className={styles.adminLink} href="/system/attendance">打刻へ戻る</Link></header>
