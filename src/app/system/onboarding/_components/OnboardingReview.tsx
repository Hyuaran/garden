import { commuteTotals, DEPENDENT_FIELDS, DEPENDENT_LABELS, displayValue, FIELD_LABELS, formatYen, STEP_FIELDS, STEPS, type CommuteRoute, type OnboardingInput } from "../_lib/onboarding";
