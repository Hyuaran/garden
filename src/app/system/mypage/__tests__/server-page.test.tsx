...
const employee = { employee_id:"EMP-0009",name:"社員A",name_kana:"シャインエー",employee_number:"EMP-1",employment_type:"正社員",birthday:"1980-08-13",email:"a@example.com",garden_role:"staff" };
