...
import { aggregateDefinitionFixture, classifyResultFlag, defaultCallMetricDates, normalizeCallMetricsRpc, parseCallMetricParams } from "./call-metrics";
...
describe("call metrics definitions", () => {
  ...
  it("uses an inclusive 30-day default", () => {
    expect(defaultCallMetricDates(new Date("2026-08-12T12:00:00Z"))).toEqual({ from: "2026-07-14", to: "2026-08-12" });
  });
